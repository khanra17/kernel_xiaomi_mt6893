...
void susfs_set_uname(void __user **user_info) {
	...
	if (!strcmp(info.release, "default")) {
		strscpy(my_uname.release, utsname()->release,
			sizeof(my_uname.release));
	} else {
		strscpy(my_uname.release, info.release,
			sizeof(my_uname.release));
	}
	if (!strcmp(info.version, "default")) {
		strscpy(my_uname.version, utsname()->version,
			sizeof(my_uname.version));
	} else {
		strscpy(my_uname.version, info.version,
			sizeof(my_uname.version));
	}
